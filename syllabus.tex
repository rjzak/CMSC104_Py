...
\rhead{CMSC 104 Section \input{section}: Problem Solving and Computer Programming}
...
\textbf{Time:} Tuesday \& Thursday 5:30 -- 6:45 \\
...
\paragraph{}The Python programming book is the \textit{recommended} textbook for this course along with suggested reading in the \hyperlink{sec:sechedule}{schedule} below corresponding to chapters in this book.

\includegraphics[scale=0.8]{Images/PythonFourthFrontCover}

\paragraph{}\textbf{Python Programming: An Introduction} by John Zelle, Fourth Edition. Franklin, ISBN 978-1590282977. e-book available at \href{https://redshelf.com/app/ecom/book/2564291/python-programming-an-introduction-to-computer-science-4th-edition-2564291-9781590282984-john-m-zelle}{https://redshelf.com}.
...
\paragraph{Software}If you're using a Windows computer, you'll need to download and install Python from \href{https://www.python.org/downloads/windows/}{python.org}. If you have a Mac, Python is already installed. In either case, you may wish to install PyCharm Community Edition from \url{https://www.jetbrains.com/pycharm/}, an editor for Python with modern conveniences.

\paragraph{}A third option is to use Google Colabatory, available at \url{https://colab.research.google.com/} which doesn't require software installation. This is the best option for students using a Chromebook.

\label{sec:cwhw}
\paragraph{Classwork \& Projects}Classwork will be submitted using Blackboard, and are due precisely one week after being assigned. For example, Classwork 1 is assigned on Tuesday, February 3\textsuperscript{rd}, therefore the due date is 11:59 PM on Monday, February 9\textsuperscript{th}. Assignments may be completed early, but \underline{\hypertarget{sec:cwhw}{late assignments} will \textbf{not}} \underline{be accepted}\footnote{Late assignments may be accepted \textit{only} in the event of a documented extenuating circumstance.}. Projects are due two weeks after assignment. Classwork and Projects indicate the assignment \& due dates.
...
90\% - 100\% & A & Class Participation & 5\% \\
80\% - 89\%  & B & Classwork & 20\% \\
70\% - 79\%  & C & Projects & 25\% \\
60\% - 69\%  & D & Quizzes & 25\% \\
$<$60\%      & F & Final Exam & 25\% 
\end{tabular}
...
\paragraph{}For borderline grades, there may be adjustments in the student's favor based on attendance, but under no circumstances will the letter grades be lower than in the standard formula. Grades will not be ``curved'' in the sense that the percentages of A's, B's and C's are not fixed. As a guideline, a student receiving an ``A'' should be able to produce correct programs for the all of the assignments and quizzes with ease. As stated in the \hyperlink{sec:cwhw}{Classwork \& Projects} section, late work will \underline{not} be accepted.
...
\begin{itemize}
\item Cite your source, don't claim it as your own (especially if using a feature of Python we don't cover in class),
...
\paragraph{AI Policy} \underline{Do not use ChatGPT} or any other type of AI for your assignments. This doesn't help you learn, and models such as ChatGPT has been known to give incorrect responses. You learn by doing, making mistakes, figuring out how to fix the mistakes, and repeating. Being given potentially incorrect answers is not learning. If you need help with the course material, please ask questions, which also helps your class participation grade. \underline{Any submitted materials which are} \underline{suspected to have been AI-generated will earn a zero and will} \underline{count as cheating!}

\paragraph{}Don't cheat, don't use AI. Repeat offenders will be reported to the Dean's office.

\section*{Schedule}\label{sec:schedule}
\paragraph{}Schedule pending.
\textit{Note: The schedule is subject to change. However, any changes will be thoroughly discussed and well disseminated.}
...
Tu Aug 25  & 1  & Introduction, Syllabus Review &  & & \hl{Quiz 0} \\ 
Th Aug 27  & 1  & Computers and Programs & 1 & 1 &  \\ \hline
Tu Sept 1  & 2  & Writing Simple Programs & 2 & 2, 3, 5 & \\
Th Sept 3  & 2  & Writing Simple Programs & & & Classwork 1 \\
Tu Sept 8  & 3  & Computing with Numbers & 3 & & \\
Th Sept 10 & 3  & Computing with Numbers & &  & Classwork 2 \\
Tu Sept 15 & 4  & \hl{Quiz 1} & & & Project 1\\
Th Sept 17 & 4  & Objects and Graphics & 4 & & Classwork 3 \\
Tu Sept 22 & 5  & Defining Functions & 5 & 7 & \\
Th Sept 24 & 5  & Defining Functions & & & \\
Tu Sept 29 & 6  & Decision Structures & 6 & & \\ \hline
Th Oct 1   & 6  &  Decision Structures & & 4 & Classwork 4 \\
Tu Oct 6   & 7  & \hl{Quiz 2} & & & Project 2\\
Th Oct 8   & 7  & Loops \& Booleans & 7 & 6 & Classwork 5 \\
Tu Oct 13  & 8  & Loops \& Booleans & & & \\
Th Oct 15  & 8  & Strings  & 8 & & \\
Tu Oct 20  & 9  & Data Collections & 9 & & \\
Th Oct 22  & 9  & Data Collections &  & 8 & Classwork 6 \\
Tu Oct 27  & 10 & \hl{Quiz 3}  & & & \\
Th Oct 29  & 10 & Persistent Data  & 10 & & Classwork 7 \\ \hline
Tu Nov 3   & 11 & Persistent Data &  & & Project 3\\
Th Nov 5   & 11 &  Simulation \& Design & 11 & & \\
Tu Nov 10  & 12 & Simulation \& Design & & & \\
Th Nov 12  & 12 & Defining Classes & 12  & &  \\
Tu Nov 17  & 13 & Defining Classes, OO-Design & 13 & & Classwork 8\\
Th Nov 19  & 13 & Object-Oriented Design & & & \\
Tu Nov 24  & 14 & \hl{Quiz 4} & & & Classwork 9 \\
Th Nov 26  & 14 & {\color{cadmiumgreen}Fall Break} & & & \\ \hline
Tu Dec 1   & 15 & Algorithm Design \& Recursion & 14 & & \\
Th Dec 3   & 15 & Algorithm Design \& Recursion,  & & 9 & Classwork 10 \\
Tu Dec 8   & 16 & Review & & & \\
Th Dec 10  & 16 & \hl{Study Day, no class} & & & \\
Tu Dec 15  & 17 & \hl{Study Day, no class} & & & \\
Th Dec 17  & 17 & \hl{Final Exam, 6-8PM.} & & & \\
\end{tabular}
%\end{comment}
...
\begin{tabular}{c c l l l c}
Date           & Week & ~~~~~~~~~~~~Topic & Textbook & Code to Joy & Assignment \\ \hline
Tu Jan 27  & 1  & {\color{cadmiumgreen}Snow Day} & & & \\
Th Jan 29  & 1  & {\color{cadmiumgreen}Snow Day}  &  & &  \\ \hline
Tu Feb 3    & 2  & Introduction, Syllabus Review & 1 & 1 & \hl{Quiz 0}, Classwork 1 \\
Th Feb 5    & 2  & Computers and Programs & 2 & & \\
Tu Feb 10  & 3  & Writing Simple Programs & 3 & 2, 5 & Classwork 2 \\
Th Feb 12  & 3  & Computing with Numbers & 4 & & Project 1\\
Tu Feb 17  & 4  & Objects and Graphics & 5 & & Classwork 3 \\
Th Feb 19  & 4  & Defining Functions &  & & \\
Tu Feb 24  & 5  & \hl{Quiz 1} & & & \\
Th Feb 26  & 5  & Defining Functions  & 6 & & \\ \hline
Tu Mar 3    & 6  & Decision Structures & & 3 & Classwork 4 \\
Th Mar 5    & 6  & Decision Structures & 7 & & Project 2\\
Tu Mar 10  & 7  & Loops \& Booleans & & 7 & Classwork 5 \\
Th Mar 12  & 7  & \hl{Quiz 2} & & 4 & \\
Tu Mar 17  & 8  & {\color{cadmiumgreen}Spring Break!} & & & \\
Th Mar 19  & 8  & {\color{cadmiumgreen}Spring Break!} & & & \\
Tu Mar 24  & 9  & Loops \& Booleans & 8 & 6 & Classwork 6 \\
Th Mar 26  & 9  & Strings & 9 & & \\
Tu Mar 31  & 10 & Data Collections & 10 & & Classwork 7 \\ \hline
Th Apr 2     & 10 & Persistent Data & & & Project 3\\
Tu Apr 7     & 11 & Persistent Data \hl{Quiz 3}& 11 & & \\
Th Apr 9     & 11 & Simulation \& Design & & & \\
Tu Apr 14   & 12 & Simulation \& Design & 12 & &  \\
Th Apr 16   & 12 & Defining Classes & & 8 & Classwork 8\\
Tu Apr 21   & 13 & Defining Classes & 13 & & \\
Th Apr 23   & 13 & Object Oriented Design & & & Classwork 9 \\
Tu Apr 28   & 14 & Object Oriented Design & & & \\
Th Apr 30   & 14 & \hl{Quiz 4} & 14 & & \\ \hline
Tu May 5    & 15 & Algorithm Design \& Recursion & & 9 & Classwork 10 \\
Th May 7    & 15 & Algorithm Design \& Recursion & & & \\
Tu May 12  & 16 & Review & & & \\
Th May 14  & 16 & \hl{Final Exam 6-8p} & & & \\
\end{tabular}
\end{comment}
