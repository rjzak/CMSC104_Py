...
\AtEndDocument{\vfill \footnotesize{Last modified: 01 February 2026}}
\AtEndDocument{\rfoot{\input{../../semester}}}
\renewcommand\thesubsection{\arabic{subsection}} % Show only subsection numbers, not section.subsection

\begin{document}
    \huge
    \textbf{Classwork 1: Introduction to Python \& PyCharm}
    \normalsize
    \\ ~~ \\
    \textbf{In-class Date: Thursday 05 February} \\
    \textbf{Due Date: Wednesday 11 February}
    
    \section*{Objectives}
    \paragraph{}To become familiar with PyCharm, a Python development environment.
    
    \section*{Assignment: First Python Script with PyCharm}
    \subsection{Install Python}
    \paragraph{}As mentioned in the syllabus, ensure that Python \url{https://www.python.org/downloads/} and PyCharm \url{https://www.jetbrains.com/pycharm/} are installed on your computer. Both are free.
    
    \subsection{Use PyCharm as a text editor}
    \paragraph{}Run PyCharm on your computer. It'll be in the Start Menu if you have a Windows machine, or in your applications folder if you have a Mac.
    
    \begin{enumerate}
        \item In PyCharm, go to ``File'' $\rightarrow$ ``New File''. A new window will appear.
        ...
        \end{itemize}
        \item Test your script by running it, go to ``Run'' $\rightarrow$ ``Run ...''.
        \begin{itemize}
            \item Fix any errors.
        \end{itemize}
