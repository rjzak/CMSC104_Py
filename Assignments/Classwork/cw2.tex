...
\rhead{CMSC 104 Section \input{../../section}: Classwork 2}
%\rhead{}
...
\begin{document}
    ...
    \normalsize
    \\ ~~ \\
    \textbf{In-class Date: Thursday 03 September} \\
    \textbf{Due Date: Wednesday 09 September}
    ...
    \paragraph{}As mentioned in the syllabus, ensure that Python and PyCharm are installed.
